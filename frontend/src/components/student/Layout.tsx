      ...
      <div className="flex items-center gap-3 sm:gap-4">
              ...
              >
                ...
                <div className="space-y-3 max-h-[300px] overflow-y-auto custom-scrollbar">
                  <div className="flex gap-3 items-start p-2 hover:bg-gray-50 dark:hover:bg-white/5 rounded-lg transition-colors cursor-pointer">
                    ...
                    <div>
                      <p className="text-sm text-gray-800 dark:text-gray-200">Attendance marked for Data Structures.</p>
                  ...
                  <div className="flex gap-3 items-start p-2 hover:bg-gray-50 dark:hover:bg-white/5 rounded-lg transition-colors cursor-pointer">
                    ...
                    <div>
                      <p className="text-sm text-gray-800 dark:text-gray-200">Upcoming class: Algorithms in 30 mins.</p>
        ...
        <div className="relative flex items-center gap-2 pl-2 sm:border-l sm:border-gray-200 sm:dark:border-white/10" ref={profileRef}>
          <button 
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 transition-colors hover:bg-gray-200 dark:hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-primary/50 overflow-hidden shrink-0"
          >
            <User size={18} />
          </button>
          <div className="hidden sm:flex flex-col items-start cursor-pointer" onClick={() => {
            ...
            <span className="text-sm font-medium text-gray-700 dark:text-gray-200 leading-tight">
              {user?.username || 'Ahmed Hussein'}
            </span>
            <span className="text-xs text-primary dark:text-primary-accent font-medium mt-0.5">
              CS-2023-0842
            </span>
          </div>
            ...
            {profileDropdownOpen && (
              ...
              >
                <div className="px-3 py-2 border-b border-gray-100 dark:border-white/5 mb-1">
                  <p className="text-sm font-medium text-gray-900 dark:text-white">{user?.username || 'Ahmed Hussein'}</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 truncate">CS-2023-0842</p>
                </div>
