...
const navGroups: NavGroup[] = [
  ...
  },
  {
    heading: 'Account',
    items: [
      { icon: UserCircle2, label: 'My Profile', path: '/student/profile' },
    ],
  },
];
      ...
      >
        ...
        <div className="shrink-0 border-t border-gray-200 dark:border-white/10 p-3">
          <div
            ...
            className={cn(
              'flex items-center gap-3 rounded-xl px-3 py-2.5 cursor-pointer hover:bg-gray-100 dark:hover:bg-white/5 transition-colors',
              ...
              {!isCollapsed && (
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="truncate text-[10px] text-gray-500 dark:text-gray-400 font-mono">
