  ...
  return (
    <>
      ...
      >
        ...
        {/* Navigation Links */}
        <nav className="flex-1 space-y-2 overflow-y-auto overflow-x-hidden p-4 custom-scrollbar">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                {isActive && (
                  <motion.div
                    layoutId="activeNavIndicatorStudent"
                ...
                <div className="flex shrink-0 items-center justify-center">
                  <item.icon size={22} className={cn(
                    "transition-colors",
                    isActive ? "text-primary drop-shadow-[0_0_8px_rgba(37,99,235,0.4)] dark:text-white dark:drop-shadow-[0_0_8px_rgba(255,255,255,0.1)]" : "text-gray-500"
                  )} />
                </div>
