  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex h-screen flex-col border-r border-gray-200 dark:border-white/10 bg-white dark:bg-dark-bg/95 backdrop-blur-xl select-none"
        )}
      >
