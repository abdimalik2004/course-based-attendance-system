...
const navGroups: NavGroup[] = [
  {
    heading: 'Overview',
    items: [
      { icon: LayoutDashboard, label: 'Dashboard', path: '/academia/dashboard' },
    ],
  },
  {
    heading: 'Structure',
    items: [
      { icon: Building2,     label: 'Faculties',          path: '/academia/faculties' },
      { icon: Network,       label: 'Departments',         path: '/academia/departments' },
      { icon: BookOpen,      label: 'Courses',             path: '/academia/courses' },
      { icon: Users,         label: 'Classes',             path: '/academia/classes' },
      { icon: GraduationCap, label: 'Academic Structure',  path: '/academia/academic-structure' },
    ],
  },
  {
    heading: 'Analytics',
    items: [
      { icon: BarChart3, label: 'Reports', path: '/academia/reports' },
    ],
  },
];
    ...
    <>
      ...
      >
              ...
              {group.items.map((item) => {
                ...
                return (
                  ...
                  >
                    {isActive && (
                      <motion.div
                        layoutId="activeAcademiaNavIndicator"
        ...
        <div className="shrink-0 border-t border-gray-200 dark:border-white/10 p-3">
          <div
            onClick={() => navigate('/academia/profile')}
              ...
              {!isCollapsed && (
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="truncate text-[10px] text-gray-500 dark:text-gray-400">Academia</p>
                  </div>
                  <button
