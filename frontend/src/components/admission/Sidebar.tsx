...
const navGroups: NavGroup[] = [
  ...
  },
  {
    heading: 'Students',
    items: [
      { icon: Users,       label: 'Students',                  path: '/admission/students' },
      { icon: CheckSquare, label: 'Students Approval',         path: '/admission/approval' },
      { icon: Camera,      label: 'Face Registration',         path: '/admission/face-registration' },
    ],
  },
];
...
export function Sidebar() {
  ...
  const displayName = (() => {
    ...
    return user?.username ?? 'Admissions';
  })();
              ...
              {group.items.map((item) => {
                ...
                return (
                  ...
                  >
                    {isActive && (
                      <motion.div
                        layoutId="activeNavIndicatorAdmission"
              ...
              {!isCollapsed && (
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="truncate text-[10px] text-gray-500 dark:text-gray-400">Admissions</p>
                  </div>
                  <button
