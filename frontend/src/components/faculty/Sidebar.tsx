...
const navGroups: NavGroup[] = [
  ...
  },
  {
    heading: 'My Faculty',
    items: [
      { icon: GraduationCap, label: 'Teachers', path: '/faculty/teachers' },
      { icon: Users, label: 'Students', path: '/faculty/students' },
      { icon: BookOpen, label: 'Courses', path: '/faculty/courses' },
      { icon: School, label: 'Classes', path: '/faculty/classes' },
  ...
  },
  {
    heading: 'Management',
    items: [
      { icon: UserPlus, label: 'Assign Teacher', path: '/faculty/assign-teacher' },
      ...
      { icon: FileCheck, label: 'Excuse Requests', path: '/faculty/excuse-requests' },
    ],
  },
];
              ...
              <AnimatePresence mode="wait">
                {!isCollapsed && (
                  <motion.p
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="mb-1 px-3 text-[10px] font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500"
                  >
                    {group.heading}
                  </motion.p>
                )}
              ...
              {!isCollapsed && (
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="truncate text-[10px] text-gray-500 dark:text-gray-400">Faculty</p>
                  </div>
                  <button
