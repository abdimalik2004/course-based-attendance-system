...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: ClipboardList, label: 'Attendance List', path: '/admin/attendance-list' },
    ],
  },
  {
    ...
    items: [
      ...
      { icon: ScrollText, label: 'Activity Log', path: '/admin/activity-log' },
    ],
  },
  {
    heading: 'System',
              ...
              {!isCollapsed && (
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="truncate text-[10px] text-gray-500 dark:text-gray-400">Administrator</p>
                  </div>
                  <button
